<?php
    ...
    $g_lang["bfs_name"] = "Αναζήτηση κατά πλάτος";
    $g_lang["coloring_name"] = "Χρωματισμός γράφου";
    $g_lang["find_connection_component_name"] = "Εύρεση συνδεδεμένων στοιχείων";
    $g_lang["dfs_name"] = "Αναζήτηση κατά βάθος";
    $g_lang["eulerin_loop_name"] = "Εύρεση κύκλου Euler";
    $g_lang["eulerin_path_name"] = "Εύρεση μονοπατιού Euler";
    $g_lang["fiold_name"] = "Αλγόριθμος Floyd–Warshall";
    $g_lang["graph_reorder_name"] = "Αναδιάταξη του γράφου";
    $g_lang["hamiltoian_cycle_name"] = "Εύρεση κύκλου Hamilton";
    $g_lang["hamiltonian_path_name"] = "Εύρεση μονοπατιού Hamilton";
    $g_lang["max_flow_name"] = "Εύρεση μέγιστης ροής";
    $g_lang["minimum_spanning_tree"] = "Εύρεση ελάχιστου ζευγνύοντος δέντρου";
    ...
    $g_lang['select_second_graph_for_search_subgraph'] = "Διαλέξτε ένα γράφο στον οποίο θα ψάξουμε για ισομορφικούς υπογράφους. Κάντε κλικ σε οποιονδήποτε κόμβο του γράφου";
    $g_lang['graphs_isomorph'] = "Οι γράφοι είναι ισόμορφοι";
    $g_lang['graphs_not_isomorph'] = "Οι γράφοι δεν είναι ισόμορφοι";
    $g_lang['number_of_isomorph_subgraph_is'] = "Ο αριθμός των ισομορφικών υπογράφουν είναι ";
    $g_lang['graph_has_no_isomorph_subgraph'] = "Ο γράφος δεν περιέχει ισομορφικούς υπογράφους";
